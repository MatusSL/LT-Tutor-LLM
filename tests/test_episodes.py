...
class TestEpisodes(unittest.TestCase):
        ...
        for episode_id in range(first_episode, last_episode + 1):
            ...
            try:
                ...
                with open(filename, "r", encoding="utf-8") as file:
                    ...
                    self.assertEqual(episode_id, current_episode_id,
                                     error_text)
    ...
    def test_duplication_of_words_in_first_thirty_episodes(self):
        ...
        self.assertNotEqual(expected_vocab_length, number_of_unlocked_words,
                            error_message)
    ...
    def test_word_count_in_first_thirty_episodes(self):
        ...
        error_message = f"Length mismatch: expected {expected_length}, got {actual_length}"
            ...
            try:
                ...
                with open(filename, "r", encoding="utf-8") as file:
                    ...
                    self.assertIn("id", episode_data,
                                  f"Episode {episode_id} missing 'id' field")
                    self.assertIn(
                        "unlocked_words", episode_data,
                        f"Episode {episode_id} missing 'unlocked_words' field")
                    self.assertIn(
                        "unlocked_tenses", episode_data,
                ...
                with open(filename, "r", encoding="utf-8") as file:
                    ...
                    for tense in tenses:
                        self.assertIsInstance(
                            tense, str,
                            f"Episode {episode_id}: tense must be string")
                        self.assertGreater(
                            len(tense), 0,
